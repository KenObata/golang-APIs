...
CREATE TABLE IF NOT EXISTS job(id serial PRIMARY KEY, company varchar(255) NOT NULL, title varchar(255) NOT NULL, url varchar(255) NOT NULL, dateadded varchar(255) NOT NULL);
